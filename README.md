...
Infrastructure Penetration Testing Report – JOHNWICK

A detailed penetration testing and security assessment report focused on identifying and exploiting vulnerabilities within a Linux-based infrastructure host. This project demonstrates a complete attack lifecycle — from reconnaissance and enumeration to privilege escalation and full root compromise — while documenting technical findings, exploitation methodology, risk analysis, and remediation recommendations.
...
This project was conducted in a controlled lab environment strictly for educational and authorized security testing purposes. Unauthorized access or testing against systems without explicit permission is illegal and unethical.
